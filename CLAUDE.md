...
| `modules/features/editor/CLAUDE.md` | why Helix tracks master via its flake input, why its grammar list is filtered to GitHub, and how a vault scopes markdown behind workspace trust |
